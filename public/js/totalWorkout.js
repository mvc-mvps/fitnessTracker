...
const goals = () => {
  ...
  const goalTotal = goalArrayInt.reduce(function(a, b) {return a + b; }, 0);
  const completedTotal = completedArrayInt.reduce(function(a, b) {return a + b; }, 0);
  let value = goalTotal - completedTotal;
  if(value > 0) {
    alert(`Almost there! Only ${value} reps/minutes left until you hit your goals`);
  } else if (value < 0) {
